...
function TS_AtVasMeas_Flow_2019d_otsBW(Image,Reso,Type)
% TS_AtVasMeas_Flow_2019c(Image,Reso,Type)
% Edit log, 
...
if strcmpi(ok(1),'y')
     ...
     Image(:,:,Sind:end) = SV;
     save([STR '_TOPHAT.mat'],'Image','ok','Reso','STR','Sind','Type') 
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Main Flow %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
Block_siz = ones(1,2)*ceil(size(REmphasized,1)/5);
bw = TS_im2bw_block_v2019a(REmphasized,Block_siz);
keyboard
...
TIME = tic;
output = TS_AutoAnalysisDiam_SEG_v2019c(mfImage,Reso,Type,SEG);
