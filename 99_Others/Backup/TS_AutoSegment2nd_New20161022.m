function Output = TS_AutoSegment2nd_New20161022(Segmentdata,Cutlen)
...
bwthindata = TS_Skeleton3D(bwthindata);

%% Re AutoSegment
Output = [];
% Output = TS_AutoSegment1st(bwthindata(2:end-1,2:end-1,2:end-1),Reso);
Output = TS_AutoSegment1st_New20161021(bwthindata(2:end-1,2:end-1,2:end-1),Reso,...
    Segmentdata.AddBP);
