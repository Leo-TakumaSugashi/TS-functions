function Output = TS_AutoSegment1st_v2(bwthindata,varargin)
...
function Output = TS_AtSEGin(Output,bwthindata,BPcentroid,BPgroup,L_BPgroup,EndP,BPmatrix)
