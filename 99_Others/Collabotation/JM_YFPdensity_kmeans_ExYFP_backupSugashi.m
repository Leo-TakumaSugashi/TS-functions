function JM_YFPdensity_kmeans_ExYFP_backupSugashi(Data,varargin)
% JM_YFPdensity_kmeans_ExYFP(Data,Depth,ClassNum)
% JM_YFPdensity_kmeans_ExYFP(Data)
% 
%  * * * Input * * *
% ResultData = JM_YFPdensity_kmeans_v1(~)
