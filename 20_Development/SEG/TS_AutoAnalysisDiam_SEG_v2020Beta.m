...
function [output,ppdata] = TS_AutoAnalysisDiam_SEG_v2020Beta(...
    ...
    for ni = 1:2:nargin
        switch lower(varargin{ni})
            ...
            case {'noisetype','noise type'}
                ...
                if ~or(max(strcmp(Option.NoiseType,{'EachPoint','Slice'})),isnumeric(Option.NoiseType))
                    error('input option "SNR Units" is not correct')
                end                
            case 'measuretype'
...
EachStep = min(EachStep,512);
EachStep = max(EachStep,64);
%%  This value shoud be adjusted for ur server %%%%%%%%%%%%%%%%%%%%%%%%%%%%
EachStep = max(EachStep,512); %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
