function varargout = SegEditor_v2024(Image,Reso,SEG,varargin)

fprintf("\n   PLESE USE NEW VEERSION. \n\n\t SegEditor_v2025 \n\n")
error("SegEditor_v2024 is END of support... new Version is v2025")
% varargout = SegEditor_v2024(Image,Reso,SEG,varargin)
% 
...
% 
%   SegEditor_v20##(Image,Reso,SEG)
%   SegEditor_v20##(Image,Reso,SEG,AdjImage,AdjReso)
...
fprintf('\n\n')
fprintf('==== ==== ==== ==== Starting Segment Editor ver.2024 ==== ==== ====\n')
if islogical(Image)
    Image = uint8(Image);
end
if length(Reso)<3
...
H = Segment_GUI;
H.MaxChannels = size(Image,5);
H.SEGview_SelectedLineColor = [.8 .8 .8];
H.SEGview_SelectedLineWidth = 3;
H.SEGview_SelectedLineStyle = '-';
H.Name = mfilename;
H.Image = Image;
if size(Image,4)>1
...
%% %%%%%%%%%%%%% In Edit %%%%%%%%%%%%%%%%%
% H.Rendering.Visible = 'off';
% H.BranchEditPanel.Visible = 'on';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
