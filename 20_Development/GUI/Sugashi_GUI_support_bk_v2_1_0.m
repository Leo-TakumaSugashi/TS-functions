classdef Sugashi_GUI_support_bk_v2_1_0
   properties
...
%% Segmet Editor GUI Setting up Function
        function H = create_figure_segeditor(obj,MaxChannels)
            ...
            switch DefaultType
                case 'with Volume'
                    ...
                    PanelPosition = [[0 0 0.3 1];[0.3 0 0.4 1];[0.7 0  0.3 1]];
                case 'Slice only'
                    figurePosition = [50 30 1200 650];
                    PanelPosition = [[0 0 0.4 1];[0.25 0 0.6 1];[0.7 0  0.3 1]];
                otherwise
        ...
        %% Figure, Panel, Controller
            ...
            function CloseRequest(~,~)
                ...
                if ishandle(H.OptionsFigure)
                    delete(H.OptionsFigure)
                end        
            end
            H.OptionsFigure = uifigure(...
                'Name','Segment Editor -Options-',...
...
%             
            ...
            OPT = cell(22,4);k = 1;
            OPT{k,1} = '  Step Size [µm]';      OPT{k,2} = '10';   k=k+1;
            OPT{k,1} = ' Lim: Maximum Number';  OPT{k,2} = '10';   k=k+1;
            OPT{k,1} = ' Lim: Minimum Number';  OPT{k,2} = '2' ;   k=k+1;
            OPT{k,1} = ' Lim: Max. Length[µm]'; OPT{k,2} = '12';   k=k+1;
            OPT{k,1} = ' Lim: Min. Length[µm]'; OPT{k,2} = '6' ;   k=k+1;
