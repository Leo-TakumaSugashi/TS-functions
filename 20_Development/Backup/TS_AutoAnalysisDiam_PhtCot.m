function output = TS_AutoAnalysisDiam_PhtCot(fImage,skel,NewReso,Len)
...
%  
%  see alo so , TS_AutoAnalysisDiam_AddAdjPreFWHM_perSlice  Group...
...
output.theta = theta;
output.Reso = NewReso;
output.Size = size(fImage);
output.Len = Len;
output.Threshold = 'sp5';
