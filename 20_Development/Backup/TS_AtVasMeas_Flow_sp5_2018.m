...
function output = TS_AtVasMeas_Flow_sp5_2018(Image,Reso)
...
warning('Chenge program.... Surface Index...')
if isempty(Sind)
Sind = {'Inf'};
end
 Sind = eval(Sind{1});
...
save NewSEGandDiamImage SEG_diam DiamImage SNRImage NewDiamImage
