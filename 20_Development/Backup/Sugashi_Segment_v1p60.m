classdef Sugashi_Segment_v1p60
   ...
   properties
      ...
      SegSelection_RangeMod(1,3) double = [30 30 10]; % [ x y z]
      ...
      SEGview_Type(1,:) char {mustBeMember(SEGview_Type,{'same','Type','Diameter','Length','AverageDiameter'})} = 'Type'  
