...
{
  emxFree_boolean_T(&pStruct->Output);
  emxFree_boolean_T(&pStruct->AddBP);
  emxFree_boolean_T(&pStruct->Branch);
  emxFree_boolean_T(&pStruct->BranchGroup);
  emxFree_boolean_T(&pStruct->End);
  emxFree_real_T(&pStruct->BPmatrix);
  emxFree_boolean_T(&pStruct->Original);
}
...
{
  emxInit_boolean_T(sp, &pStruct->Output, 3, srcLocation, doPush);
  emxInit_boolean_T(sp, &pStruct->AddBP, 3, srcLocation, doPush);
  emxInit_boolean_T(sp, &pStruct->Branch, 3, srcLocation, doPush);
  emxInit_boolean_T(sp, &pStruct->BranchGroup, 3, srcLocation, doPush);
  emxInit_boolean_T(sp, &pStruct->End, 3, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->BPmatrix, 2, srcLocation, doPush);
  emxInit_boolean_T(sp, &pStruct->Original, 3, srcLocation, doPush);
}
...
/* End of code generation (AutoSegment_emxutil.c) */
