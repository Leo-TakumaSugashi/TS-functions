  ...
  *varargout_2, emxArray_int32_T *varargout_3)
{
  ...
  emxEnsureCapacity_int32_T(sp, varargout_1, hi, &ae_emlrtRTEI);
  loop_ub = ndx->size[0];
  ...
  emxEnsureCapacity_int32_T(sp, vk, hi, &wc_emlrtRTEI);
  loop_ub = varargout_1->size[0];
  for (hi = 0; hi < loop_ub; hi++) {
    st.site = &un_emlrtRSI;
  ...
  emxEnsureCapacity_int32_T(sp, varargout_3, hi, &xc_emlrtRTEI);
  loop_ub = vk->size[0];
  for (hi = 0; hi < loop_ub; hi++) {
  ...
  emxEnsureCapacity_int32_T(sp, varargout_2, hi, &xc_emlrtRTEI);
  loop_ub = vk->size[0];
  for (hi = 0; hi < loop_ub; hi++) {
