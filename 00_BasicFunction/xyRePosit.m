...
fgh = gcbf;
ManualReposit(fgh,oh,[])
end

function ManualReposit(fgh,oh,p)
TemplateZT = getappdata(fgh,'TemplateZT');
if isempty(TemplateZT)
    return
end
if and(TemplateZT(1)==GetSliceNow,TemplateZT(2)==GetTimeNow)
    return
