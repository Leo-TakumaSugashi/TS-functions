function A = TS_Skeleton3D_v6(bw)
% 
...
%                 TF3 = 
        ...
        waitbar(k/numel(newY),waitbarh,['Please wait...  ' num2str(n) '/' num2str(Endn)]) 
...
close(waitbarh)
TIMEout = toc(timeval);
disp(['Time : ' num2str(floor(TIMEout/60)) '''' num2str(TIMEout-60*floor(TIMEout/60)) '"'])
