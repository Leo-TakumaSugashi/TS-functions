function varargout = TS_3dslider_AutoReposi(varargin)
%% TS_3dslider(Image)
...
disp('   ...Open TS_3dslider_AutoReposi')
...
%% Auto Reposi
sh = TS_SliceReposition(data(:,:,1),data(:,:,2));
[~,B] = TS_Shift2pad_vEachSlice(data(:,:,1),data(:,:,2),sh,'crop');
data(:,:,2) = B;
