function TS_setupdefault2024(varargin)
...
%% Colorbar
set(0,'defaultColorbarColor',ColorbarColor)
%% Figure and Axes option
set(0,'defaultAxesColor',AxesColor);
set(0,'defaultAxesXColor',AxesXYZColor);
set(0,'defaultAxesYColor',AxesXYZColor);
set(0,'defaultAxesZColor',AxesXYZColor);
set(0,'defaultAxesGridColor',GridColor);
set(0,'defaultAxesMinorGridColor',MinorGridColor);
