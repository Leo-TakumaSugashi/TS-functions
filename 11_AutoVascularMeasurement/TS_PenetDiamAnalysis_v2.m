function [PenetDiamImage,DiamImage,bw,skel,PSNRImage] = TS_PenetDiamAnalysis_v2(Image,Reso)
%% this func is for sp5 (PMT)
% [PenetDiamImage,bw,skel] = TS_PenetDiamAnalysis_v2(Image,Reso)

% editor's log...
% 2017 06 16 , sugashi,
%     SN‚É‚æ‚é‚©‚¢‚¹‚«Œ‹‰Ê‚ÌOupputo‚ð§ŒÀB
